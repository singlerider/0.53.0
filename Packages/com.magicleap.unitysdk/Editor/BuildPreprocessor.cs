...
namespace MagicLeap
{
    ...
    public class ColorSpaceBuildPreprocessor : IPreprocessBuildWithReport, IPostGenerateGradleAndroidProject
    {
        ...
        {
            if (PlayerSettings.Android.androidTargetDevices == AndroidTargetDevices.RelishDevicesOnly)
            {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            if (report.summary.platform == BuildTarget.Android
                && PlayerSettings.Android.androidTargetDevices == AndroidTargetDevices.RelishDevicesOnly)
            {
                SetLinearColorSpace();
