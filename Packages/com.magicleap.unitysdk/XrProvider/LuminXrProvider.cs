    ...
    public class LuminXrProvider
    {
        ...
        private static string LibHostDirForXRPackage
        {
            get
            {
                ...
                return "Windows";
#elif UNITY_EDITOR_OSX
                // this lowercase 'm' is the only diff between LibHostDir and LibHostDirForXRPackage
                return "macOS";
#else
                throw new NotSupportedException("Not supported on this platform!");
#endif
        ...
        public static void AddLibrarySearchPaths(List<string> librarySearchPaths)
        {
            ...
            try
            {
                ...
                string loaderLibPath = Path.Combine(packagePath, "Libs", LibHostDir);
                ...
                if (librarySearchPaths.Count > 0)
                {
                    ...
                    var resultCode = LuminXrProviderNativeBindings.MLZIIsServerConfigured(out bool isZIRunning);
