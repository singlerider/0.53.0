...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed class LuminXrProviderNativeBindings : Native.MagicLeapNativeBindings
    {
        ...
        public static extern void LuminXrProviderAddLibraryPath([MarshalAs(UnmanagedType.LPStr)] string path);
        ...
        public static extern void UnityMagicLeap_SetLibraryPath([MarshalAs(UnmanagedType.LPStr)] string path);

        [DllImport(MLSdkLoaderDll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void MLSdkLoaderResetLibraryPaths();

        [DllImport(MLSdkLoaderDll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void MLSdkLoaderUnloadAllLibraries();

        [DllImport(MLSdkLoaderDll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern MLResult.Code MLZIIsServerConfigured([MarshalAs(UnmanagedType.I1)] out bool isConfigured);
#endif
