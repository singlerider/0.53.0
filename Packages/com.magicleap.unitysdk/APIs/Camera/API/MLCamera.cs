...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLCamera : MLAPIBase
    {
        ...
        /// <summary>
        /// Creates an MLCamera instance and connects the camera device.
        /// </summary>
        ...
        /// <summary>
        /// Get the stream capabilities of the connected camera.
        /// </summary>
        ...
        /// User can request camera intrinsics for a specific resolution using
        /// Width & Height. If no width and height is provided, default resolution(2048,1536) is assumed.
        /// Use as input parameter is reserved for future use.Only camera intrinsic
        /// parameters for default resolution (2048,1536) is supported.
        /// As an output parameter, the API will fill the Camera intrinsic parameters.
        /// </param>
        public MLResult GetIntrinsicCalibrationParameters(ref IntrinsicCalibrationParameters outParameters) =>
            InternalGetIntrinsicCalibrationParameters(ref outParameters);
