...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLCamera
    {
        ...
        internal partial class NativeBindings : Native.MagicLeapNativeBindings
        {
            ...
            [DllImport(MLCameraDll, CallingConvention = CallingConvention.Cdecl)]
            internal static extern MLResult.Code MLCameraGetIntrinsicCalibrationParameters(ulong contextHandle, ref MLCameraIntrinsicCalibrationParameters intrinsic);
