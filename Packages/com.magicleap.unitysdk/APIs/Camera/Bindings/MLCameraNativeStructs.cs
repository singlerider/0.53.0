...
namespace UnityEngine.XR.MagicLeap
{
    public sealed partial class MLCamera
    {
        internal partial class NativeBindings
        {
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct MLCameraDeviceAvailabilityInfo
            {
                public Identifier CamId;
            ...
            /// </summary>
            [StructLayout(LayoutKind.Sequential)]
            public struct MLCameraIntrinsicCalibrationParameters
            {
                ...
                /// </summary>
                /// <returns>A new instance of this struct.</returns>
                public static MLCameraIntrinsicCalibrationParameters Create(uint width = 2048, uint height = 1536)
                {
                    return new MLCameraIntrinsicCalibrationParameters
                    {
                        Version = 1u,
                        Width = width,
                        Height = height,
                        ...
                        Fov = 0f,
                        Distortion = Enumerable.Repeat(0.0d, MLCameraMaxDistortionCoefficients).ToArray()
                    };
                }
            }
        }
