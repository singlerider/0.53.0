...
namespace UnityEngine.XR.MagicLeap
{
    public sealed partial class MLCVCamera
    {
        ...
        private readonly static ProfilerMarker nativeMLCVCameraGetIntrinsicCalibrationParametersPerfMarker = new ProfilerMarker("MLCVCameraNativeBindings.MLCVCameraGetIntrinsicCalibrationParameters");
        private readonly static ProfilerMarker nativeMLCVCameraGetFramePosePerfMarker = new ProfilerMarker("MLCVCameraNativeBindings.MLCVCameraGetFramePose");

        //Profiler markers for MLCVCamera calls

        private readonly static ProfilerMarker getIntrinsicCalibrationParametersPerfMarker = new ProfilerMarker("MLCVCameraNativeBindings.GetIntrinsicCalibrationParameters");
