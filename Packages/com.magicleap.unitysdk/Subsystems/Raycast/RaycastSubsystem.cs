...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed class RaycastSubsystem : XRRaycastSubsystem
    {
        ...
        {
            [DllImport(MLPerceptionClientDll, CallingConvention = CallingConvention.Cdecl, EntryPoint = "MLRaycastCreate")]
            public static extern MLApiResult Create(out ulong handle);

            [DllImport(MLPerceptionClientDll, CallingConvention = CallingConvention.Cdecl, EntryPoint = "MLRaycastDestroy")]
