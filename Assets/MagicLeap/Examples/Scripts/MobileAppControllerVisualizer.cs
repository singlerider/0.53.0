...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MobileAppControllerVisualizer.cs" company="Magic Leap, Inc">
//
...
#if UNITY_MAGICLEAP || UNITY_ANDROID
                UpdateTouchIndicator(_touch1Indicator,controllerActions.IsTracked.ReadValue<bool>(), controllerActions.Touchpad1Position.ReadValue<Vector2>());
