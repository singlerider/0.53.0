...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="VirtualCursor.cs" company="Magic Leap, Inc">
//
...
#pragma warning restore 414
        ...
        private void UpdateTouchPosition()
        {
            if (_touchActiveBefore)
            {
                ...
                Vector2 currTouchPos = controllerActions.Touchpad1Position.ReadValue<Vector2>();
                pos += (currTouchPos - _prevTouchPos) * _sensitivity;
                transform.localPosition = pos;
            }
            else
            {
                _prevTouchPos = controllerActions.Touchpad1Position.ReadValue<Vector2>();
            }
