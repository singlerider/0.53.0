...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="HandVisualizer.cs" company="Magic Leap, Inc">
//
...
namespace MagicLeap.Examples
{
    ...
    public class HandVisualizer : MonoBehaviour
    {
        ...
        private InputSubsystem.Extensions.MLHandTracking.HandType _handType = InputSubsystem.Extensions.MLHandTracking.HandType.Left;
        ...
        void Update()
        {
            ...
            this.handDevice.TryGetFeatureValue(CommonUsages.isTracked, out bool isTracked);
            ...
            for (int i = 0; i < this._pinkyFingerBones.Count; ++i)
            {
                 ...
                 this._pinkyFinger[i].gameObject.SetActive(isTracked);
            }
            ...
            for (int i = 0; i < this._ringFingerBones.Count; ++i)
            {
                ...
                this._ringFinger[i].gameObject.SetActive(isTracked);
            }
            ...
            for (int i = 0; i < this._middleFingerBones.Count; ++i)
            {
                ...
                this._middleFinger[i].gameObject.SetActive(isTracked);
            }
            ...
            for (int i = 0; i < this._indexFingerBones.Count; ++i)
            {
                ...
                this._indexFinger[i].gameObject.SetActive(isTracked);
            }
            ...
            for (int i = 0; i < this._thumbBones.Count; ++i)
            {
                ...
                this._thumb[i].gameObject.SetActive(isTracked);
            }
            ...
            for (int i = 0; i < this._wristBonePositions.Count; ++i)
            {
                ...
                this._wrist[i].gameObject.SetActive(isTracked);
            }
            ...
            _center.gameObject.SetActive(isTracked);
#endif
        }
        ...
        private void Initialize()
        {
            if (!this.handDevice.isValid)
            {
                this.handDevice = InputSubsystem.Utils.FindMagicLeapDevice(InputDeviceCharacteristics.HandTracking | (this._handType == InputSubsystem.Extensions.MLHandTracking.HandType.Left ? InputDeviceCharacteristics.Left : InputDeviceCharacteristics.Right));
            }
